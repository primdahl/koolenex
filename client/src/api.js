...
export const api = {
  ...
  busConnect: (host, port, projectId) =>
    req('POST', '/bus/connect', { host, port, projectId }),
  busConnectUsb: (devicePath, projectId) =>
