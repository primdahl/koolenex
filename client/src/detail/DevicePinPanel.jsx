        ...
        >
          ...
          >
            <Badge
              ...
              color={STATUS_COLOR[dev.status] || C.dim}
            />
            {busConnected && (
              <>
                {reachability !== null && (
          ...
          <>
            ...
            >
              {[
                ...
                ['Order #', dev.order_number, 'order_number', dev.order_number],
                ...
                dev.bus_current
                  ...
                  : null,
                dev.width_mm
                  ? ['Width', dev.width_mm + ' mm', null, dev.width_mm + ' mm']
                  : null,
              ]
                .filter(Boolean)
                .filter(([, v]) => v)
            ...
            <EditableRtfField
              ...
              onSave={
                onUpdateDevice
                  ? (v) => onUpdateDevice(dev.id, { description: v })
                  : null
              }
            />
            <EditableRtfField
              ...
              onSave={
                onUpdateDevice
                  ? (v) => onUpdateDevice(dev.id, { comment: v })
                  : null
              }
            />
            <EditableRtfField
              ...
              onSave={
                onUpdateDevice
                  ? (v) => onUpdateDevice(dev.id, { installation_hints: v })
                  : null
              }
            />
            <SameDeviceSection
                ...
                <tbody>
                  {devCOs.map((co, i) => (
                    <tr key={i} className="rh">
                      ...
                      <TD>
                        <span style={{ color: C.text }}>{co.name || '—'}</span>
                      </TD>
                      <TD>
